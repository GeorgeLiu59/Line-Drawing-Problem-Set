...
def plotting_definition_template(df):
    ...
    decision_makers.append(DecisionMaker(name_pattern="resnet18_base",
                           color=rgb(65, 90, 140) , marker="o", df=df,
                           plotting_name="ResNet-18-Base"))
    decision_makers.append(DecisionMaker(name_pattern="resnet18_linecolor",
                           color=rgb(210, 150, 0), marker="o", df=df,
                           plotting_name="ResNet-18-Linecolor"))
