...
# Use environment variable if set, otherwise use path relative to this file
_MODELVSHUMAN_ENV = os.environ.get("MODELVSHUMANDIR")
if _MODELVSHUMAN_ENV:
    PROJ_DIR = str(_MODELVSHUMAN_ENV)
else:
    # Get the directory containing this file (modelvshuman/), then go up one level
    _THIS_FILE_DIR = dirname(abspath(__file__))
    PROJ_DIR = dirname(_THIS_FILE_DIR)
