...
IMAGENET_CATEGORIES_FILE = pjoin(_THIS_DIR, "categories.txt")
WNID_SYNSETS_MAPPING_FILE = pjoin(_THIS_DIR, "WNID_synsets_mapping.txt")
...
def get_ilsvrc2012_training_WNID(entity):
    ...
    for hyper in hypernyms:
        ...
        with open(WNID_SYNSETS_MAPPING_FILE) as f:
            for line in f:
                category = get_category_from_line(line)
